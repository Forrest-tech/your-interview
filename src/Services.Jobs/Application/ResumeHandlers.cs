...
//  一人一份主版本 —— 简历是长期资产,按岗微调不改主版本。
//  Forrest 2026-09-18 定夺:放 Jobs 域(求职资产),不放 Assessment。
// ============================================================================
...
public sealed class GetResumeQueryHandler(JobsDbContext db)
...
public sealed class SaveResumeCommandHandler(JobsDbContext db)
...
public sealed class DeleteResumeCommandHandler(JobsDbContext db)
